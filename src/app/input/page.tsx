          ...
          <fieldset className={styles.fieldset}>
            ...
            <div className={styles.radioGroup}>
              {henkeiModeList.map((item, index) => (
                <label
                  key={item.id}
                  className={`${styles.radioLabel} ${uiState.henkeiModeStyle[index] !== 'Enable' ? styles.disabled : ''
                    }`}
                >
                  <input
                    type="radio"
          ...
          <fieldset className={styles.fieldset}>
            ...
            <div className={styles.radioGroup}>
              {uragomeChunyukoList.map((item, index) => (
                <label
                  key={item.id}
                  className={`${styles.radioLabel} ${uiState.uragomeChunyukoStyle[index] !== 'Enable' ? styles.disabled : ''
                    }`}
                >
                  <input
                    type="radio"
              ...
              <div className={styles.liner}>
                ...
                <div className={`${styles.radioGroup} ${styles.marginLeft}`}>
                  {lockBoltLengthList.map((item, index) => (
                    <label
                      key={item.id}
                      className={`${styles.radioLabel} ${uiState.lockBoltLengthStyle[index] !== 'Enable' ? styles.disabled : ''
                        }`}
                    >
                      <input
                        type="radio"
              ...
              <div className={styles.liner}>
                ...
                <div className={`${styles.radioGroup} ${styles.marginLeft}`}>
                  {downwardLockBoltLengthList.map((item, index) => (
                    <label
                      key={item.id}
                      className={`${styles.radioLabel} ${uiState.downwardLockBoltLengthStyle !== 'Enable' ? styles.disabled : ''
                        }`}
                    >
                      <input
                        type="radio"
